# -*- coding: utf-8 -*-
"""搜 '白羊宫' UTF-16/UTF-8，验证 ItemTxt 行首（+0x40=ANSI code）"""
import sys, ctypes
...
needles = {
    "utf16": "白羊宫钥匙".encode("utf-16-le"),
    "utf8": "白羊宫钥匙".encode("utf-8"),
}
...
for k, v in found.items():
    ...
    for x in sorted(set(v)):
        ...
        c00 = mem.read(pid, h, x - 4, 4)   # 行首前 4 字节（可能 code 在前）
        print(f"  {x:#x}: -4={c00!r} +0x40={c40!r} nType={ntype[0] if ntype else -1}")
